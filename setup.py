...
setup(
    ...
    description='A sample project that shows how to package code properly',
    ...
    keywords='python packaging sample demo',
    ...
    entry_points={
        'console_scripts': ['echotool=sample.commandline_tools:echo']
    },
)
